...
public class FormCadastroFornecedor extends javax.swing.JInternalFrame {
    ...
    public FormCadastroFornecedor(Object obj) {
        this();
        ...
        if ( f != null ){
            ...
            cbxAtivo.setSelectedIndex(f.getFgAtivo()==0 ? 1 : 0);
        }
    ...
    private void initComponents() {
        ...
        lblCnpj.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        lblCnpj.setText("CNPJ");

        txtCnpj.setFont(new java.awt.Font("Tahoma", 0, 36)); // NOI18N
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        f.setFgAtivo(cbxAtivo.getSelectedIndex() == 0 ? 1 : 0);

        int res;
        if (txtId.getText().isEmpty()){
            res = new FornecedorDAO().inserir(f);
        }else{
            f.setId(Integer.parseInt(txtId.getText()));
            res = new FornecedorDAO().atualizar(f);
        }
